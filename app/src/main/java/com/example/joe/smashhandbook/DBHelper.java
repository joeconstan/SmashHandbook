...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public void createTerms(SQLiteDatabase db){
        ...
        dbtermdesc[15] = "A hitbox is simply the area of your move that can hit and damage the opponent.";
        dbtermdesc[16] = "Hitstun occurs when you've been hit by an attack, and temporarily cannot act out of it. This was a much bigger deal in melee.";
        dbtermdesc[17] = "Hoo Hah is the name of Diddy Kong's down throw to up air combo, which was more deadly before he was nerfed.";
        dbtermdesc[18] = "A hurtbox is an area of your character that is susceptible to damage and attacks.";
        ...
        dbtermdesc[22] = "Jank is a term for when something really wacky happpens. For example, Bowser's up throw has a windbox that can cause really early deaths.";
        ...
        dbtermdesc[24] = "Popping off is what people do when they win a game or set, and are excited about it. It just means celebrating. It's the source of many memes.";
        dbtermdesc[25] = "Pummelling is when you have grabbed your opponent but not thrown them yet, but instead you press grab again, or A. It adds a small amount of damage everytime you pummel someone.";
        ...
        dbtermdesc[30] = "If you use a move too often, it becomes stale, which means it has less knockback (and damage?). It is a bit more complicated, though. Here is a link to a good explanation.";
